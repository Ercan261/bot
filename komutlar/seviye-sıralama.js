...
exports.run = async (client, msg, args) => {
  ...
  if (msg.channel.id !== '736659698358681622') return msg.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.**`).then(m => m.delete(5000));
      let u = msg.mentions.users.first() || msg.author;
        ...
        .setTitle(`PRONOOB | Seviye Sistemi`)
        .setColor('RANDOM')
        .setDescription(`${str}`)
