...
exports.run = async (client, message, args) => {
    ...
    .addField(':warning: Uyarı :warning:', '`p!sunucutanıt` adlı komutu özel mesajlarda kullanamazsın.')
  ...
  .setTitle('BAŞARILI')
.setDescription('Sunucunuz Başarıyla [Destek Sunucusunda Yani Burada Tanıtıldı](https://discord.gg/AP8heK).\n12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
        .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('737366172089057332').send(embed)
            });
